 ...
 *
 */
int16_t ECOCALLMETHOD CEcoCalculatorC_QueryInterface(/* in */ struct IEcoCalculatorX* me, /* in */ const UGUID* riid, /* out */ void** ppv) {
 ...
 *
 */
uint32_t ECOCALLMETHOD CEcoCalculatorC_AddRef(/* in */ struct IEcoCalculatorX* me) {
    CEcoCalculatorC* pCMe = (CEcoCalculatorC*)me;
 ...
 *
 */
uint32_t ECOCALLMETHOD CEcoCalculatorC_Release(/* in */ struct IEcoCalculatorX* me) {
    CEcoCalculatorC* pCMe = (CEcoCalculatorC*)me;
 ...
 *
 */
int32_t ECOCALLMETHOD CEcoCalculatorC_Addition(/* in */ struct IEcoCalculatorX* me, /* in */ int16_t a, /* in */ int16_t b) {
    CEcoCalculatorC* pCMe = (CEcoCalculatorC*)me;
    int32_t result = 0;
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoCalculatorC_Subtraction(/* in */ struct IEcoCalculatorX* me, /* in */ int16_t a, /* in */ int16_t b) {
    CEcoCalculatorC* pCMe = (CEcoCalculatorC*)me;
    int16_t result = 0;
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoCalculatorC_IEcoCalculatorY_QueryInterface(/* in */ struct IEcoCalculatorY* me, /* in */ const UGUID* riid, /* out */ void** ppv) {
    CEcoCalculatorC* pCMe = (CEcoCalculatorC*)((uint64_t)me - sizeof(struct IEcoCalculatorX*));
    int16_t result = -1;
 ...
 *
 */
uint32_t ECOCALLMETHOD CEcoCalculatorC_IEcoCalculatorY_AddRef(/* in */ struct IEcoCalculatorY* me) {
    CEcoCalculatorC* pCMe = (CEcoCalculatorC*)((uint64_t)me - sizeof(struct IEcoCalculatorX*));
 ...
 *
 */
uint32_t ECOCALLMETHOD CEcoCalculatorC_IEcoCalculatorY_Release(/* in */ struct IEcoCalculatorY* me) {
    CEcoCalculatorC* pCMe = (CEcoCalculatorC*)((uint64_t)me - sizeof(struct IEcoCalculatorX*));
 ...
 *
 */
int32_t ECOCALLMETHOD CEcoCalculatorC_Multiplication(/* in */ struct IEcoCalculatorY* me, /* in */ int16_t a, /* in */ int16_t b) {
    CEcoCalculatorC* pCMe = (CEcoCalculatorC*)((uint64_t)me - sizeof(struct IEcoCalculatorX*));
    int32_t result = 0;
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoCalculatorC_Division(/* in */ struct IEcoCalculatorY* me, /* in */ int16_t a, /* in */ int16_t b) {
    CEcoCalculatorC* pCMe = (CEcoCalculatorC*)((uint64_t)me - sizeof(struct IEcoCalculatorX*));
    int16_t result = 0;
 ...
 *
 */
int16_t ECOCALLMETHOD initCEcoCalculatorC(/*in*/ struct IEcoCalculatorX* me, /* in */ struct IEcoUnknown *pIUnkSystem) {
    CEcoCalculatorC* pCMe = (CEcoCalculatorC*)me;
    int16_t result = -1;
 ...
 *
 */
int16_t ECOCALLMETHOD createCEcoCalculatorC(/* in */ IEcoUnknown* pIUnkSystem, /* in */ IEcoUnknown* pIUnkOuter, /* out */ IEcoCalculatorX** ppIX) {
    int16_t result = -1;
    IEcoSystem1* pISys = 0;
